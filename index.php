...
<head>
  ...
  <title>Name - eCommerce Website</title>
...
<body>
  ...
  <div class="notification-toast" data-toast>
    ...
    <!-- WhatsApp icon and Contact Us link -->
    <div class="whatsapp-section">
        <ion-icon name="logo-whatsapp"></ion-icon>
        <a href="#" class="contact-link" data-whatsapp-popup>
            Contact Us
        </a>
    </div>
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <div class="header-search-container">
          ...
          <input type="search" name="search" class="search-field" placeholder="Search your product ...">
